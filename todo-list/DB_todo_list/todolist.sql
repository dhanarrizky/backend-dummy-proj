...
CREATE INDEX idx_phonenumber ON account(phonenumber);
...
-- CREATE INDEX idx_group_id_user_account ON group_note(id, user_account);

CREATE INDEX idx_group_id ON group_note(id);
CREATE INDEX idx_group_user_account ON group_note(user_account);
...
CREATE INDEX idx_note_group_id ON note(group_note_id);
